...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Matt.7" target="_blank" rel="noopener">Matthew chapter 7</a>
...
- **Self-Examination Before Correction** -- Jesus prohibits self-righteous censoriousness while affirming the need for discernment. The order is crucial: deal with your own sin first, then help others.
- **The Active Ethic of Love** -- The Golden Rule calls not merely for the avoidance of harm but for the active pursuit of others' good, summarizing the entire Old Testament revelation.
- **Decision and Its Consequences** -- The two gates, two trees, and two builders all demand a response. Hearing Jesus' words without obeying them is building on sand, no matter how impressive the structure appears.

## Connections

- **Old Testament Roots**: Deuteronomy 30:15-20 (the Two Ways of life and death), Psalm 1 (the righteous and the wicked contrasted), Ezekiel 22:27 (leaders as wolves), Proverbs 14:12 ("There is a way that seems right to a man, but its end is the way to death").
- **New Testament Echoes**: James 1:22-25 (be doers of the word, not hearers only), Romans 2:1-4 (the one who judges others condemns himself), 1 John 4:1 (test the spirits), 2 Timothy 3:5 (having the form of godliness but denying its power).
- **Parallel Passages**: Luke 6:37-49 (parallel material in the Sermon on the Plain, including the two builders), Luke 13:24 (strive to enter through the narrow door).
