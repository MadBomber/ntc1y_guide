...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Mark.5" target="_blank" rel="noopener">Mark chapter 5</a>
...
## Key Themes
- **Authority over every enemy** -- Demons, disease, and death all yield to Jesus' word and touch
- **Holiness overwhelms impurity** -- Jesus does not become unclean by contact with the unclean; instead, his holiness restores what was corrupted
- **Faith as the crucial variable** -- In each story, the human response of faith (or its absence) determines the outcome

## Connections
- **Old Testament Roots**: Exodus 14-15 (enemies destroyed in the sea); Leviticus 15:25-30 (laws of blood impurity); Numbers 15:38-41 (tassels on garments); Malachi 4:2 (healing in his wings); 1 Kings 17:17-24 (Elijah raises the dead)
- **New Testament Echoes**: Ephesians 6:12 (our struggle against spiritual powers); 1 Corinthians 15:26 (death as the last enemy); Romans 5:1-2 (peace and access through faith)
- **Parallel Passages**: Matthew 8:28-34; 9:18-26; Luke 8:26-56
...
---
*Previous: [../week-07/day-5](../week-07/day-5) | Next: [day-2](day-2)*
