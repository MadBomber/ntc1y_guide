...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Mark.7" target="_blank" rel="noopener">Mark chapter 7</a>
...
- **The abolition of the clean/unclean distinction** -- Mark's editorial note ("Thus he declared all foods clean") makes explicit the revolutionary implication of Jesus' teaching: the external boundary markers that separated Jew from Gentile have been superseded by the deeper reality of heart purity.
- **Faith as active engagement** -- The Syrophoenician woman does not simply ask; she reasons, she argues, she persists. Her faith is not passive acceptance but bold, intelligent trust that God's mercy exceeds all boundaries.
- **New creation in Gentile territory** -- The healing of the deaf man in the Decapolis fulfills Isaiah's prophecy of messianic restoration and signals that God's saving work extends beyond Israel to all peoples.

## Connections

- **Old Testament Roots**: Isaiah 35:5-6 (the deaf hear and the mute speak in the messianic age), Leviticus 11 (the dietary laws), Genesis 1:31 ("it was very good"), Exodus 19:6 ("a kingdom of priests and a holy nation").
- **New Testament Echoes**: Acts 10:9-16 (Peter's vision of the sheet with unclean animals), Acts 10:34-35 ("God shows no partiality"), Galatians 2:11-14 (the Antioch incident over table fellowship), Romans 14:14 ("nothing is unclean in itself").
- **Parallel Passages**: Matthew 15:1-31 provides the parallel account. Compare Mark's "Thus he declared all foods clean" (7:19) with Matthew's more restrained presentation, and consider what each evangelist's audience needed to hear.
