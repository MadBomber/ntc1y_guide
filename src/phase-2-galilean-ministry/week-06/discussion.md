...
- **The Sower's Audit (Mark 4)**: Review your daily routine and identify specific "thorns" -- worries, distractions, desires -- that compete with God's word in your attention. Choose one concrete step to reduce the power of one thorn this week (e.g., reducing screen time, pausing to pray before checking the news, declining an optional commitment that creates anxiety).
- **The Harvest Prayer (Matthew 9:37-38)**: Commit to praying Jesus' harvest prayer daily this week: "Lord of the harvest, send out laborers into your harvest." Each day, name a specific "field" you see -- a neighborhood, a workplace, a community -- and ask God to raise up workers for it. Be open to the possibility that you may be part of the answer.
- **The Sparrow Practice (Matthew 10:29-31)**: Each time you experience fear this week -- fear of failure, rejection, loss, or the unknown -- pause and say aloud: "My Father knows. I am of more value than many sparrows." Record what happens to the fear when you speak this truth.
...
---
*Previous: [Day 5](day-5) | Next: [Week 7](../week-07/overview)*
