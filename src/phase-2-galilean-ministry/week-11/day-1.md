...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Matt.18" target="_blank" rel="noopener">Matthew chapter 18</a>
...
- **Inverted greatness** -- Kingdom greatness is measured by humility, dependence, and willingness to serve, not by rank, power, or achievement. The child becomes the model for the disciple.
- **The seriousness of stumbling blocks** -- Causing a vulnerable believer to fall away is one of the gravest offenses in the kingdom; drastic self-examination is required to ensure we are not the cause.
- **Limitless forgiveness** -- The forgiveness received from God is so vast that any refusal to forgive others reveals a fundamental failure to understand the gospel.

## Connections

- **Old Testament Roots**: Genesis 4:24 (Lamech's seventy-sevenfold vengeance, inverted by Jesus), Ezekiel 34:11-16 (God as the shepherd who searches for the lost), Leviticus 19:17-18 (rebuke your neighbor honestly and love them as yourself).
- **New Testament Echoes**: Colossians 3:13 ("forgiving each other, as the Lord has forgiven you"), Ephesians 4:32 ("be kind to one another, tenderhearted, forgiving"), James 2:13 ("mercy triumphs over judgment").
- **Parallel Passages**: Mark 9:33-50 (parallel to the greatness and stumbling block teaching), Luke 15:3-7 (the Lost Sheep in a different context), Luke 17:3-4 (forgiveness repeated seven times a day).
