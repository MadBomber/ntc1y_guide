...
week: 11
day: 2
title: Sending Twelve, Feeding 5000, Peter's Confession, Transfiguration, Cost of
  Following
reading: Luke 9
parallel_passages: Matthew 10:5-15, Matthew 14:13-21, Matthew 16:13-28, Matthew 17:1-13,
...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Luke.9" target="_blank" rel="noopener">Luke chapter 9</a>
...
- **Mission flows from dependence** -- The Twelve are sent out with power and authority but without provisions, embodying the kingdom principle that God's work is done in God's way, through trust rather than self-sufficiency.
- **Jesus as the new Moses** -- The feeding of the five thousand, the Transfiguration, and the *exodos* conversation all position Jesus as the fulfillment of the Mosaic tradition, leading a new and greater liberation.
- **The absolute cost of discipleship** -- Following Jesus takes priority over comfort, cultural obligation, and family ties; the kingdom demands first allegiance.

## Connections

- **Old Testament Roots**: Exodus 16 (manna in the wilderness), Deuteronomy 18:15 (the prophet like Moses), Malachi 4:5 (the return of Elijah), 1 Kings 19:19-21 (Elisha's call and farewell to his family).
- **New Testament Echoes**: John 6:1-14 (the feeding with extended bread of life discourse), 2 Peter 1:16-18 (Peter's later reflection on the Transfiguration), Hebrews 11:13-16 (pilgrims with no lasting city).
- **Parallel Passages**: Matthew 10, 14, 16-17, and Mark 6, 8-9 provide fuller parallel accounts of these events.
