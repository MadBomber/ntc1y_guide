...
- **The foolishness of the cross** -- God's wisdom is revealed in the crucified Christ, which overturns all human systems of status and power
- **Unity in Christ versus personality cults** -- The church belongs to Christ, not to any human leader, and divisions based on teacher loyalty betray the gospel
