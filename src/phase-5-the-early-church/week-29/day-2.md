...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/1Cor.1" target="_blank" rel="noopener">1 Corinthians chapter 1</a>
...
## Key Themes
- **The cross as the criterion of all wisdom** -- Every value system, every claim to superiority, every source of boasting is dismantled by the crucified Christ
- **God's deliberate inversion of human values** -- God chooses the foolish, weak, and despised not despite their inadequacy but because of it, so that his power alone receives glory
- **Unity grounded in Christ, not in human leaders** -- The church's identity is found in the one who was crucified for them, not in the teachers who serve them
