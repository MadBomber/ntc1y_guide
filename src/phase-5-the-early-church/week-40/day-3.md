...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Eph.2" target="_blank" rel="noopener">Ephesians chapter 2</a>
...
2. Ephesians 2:8-9 says salvation is "not a result of works, so that no one may boast," while verse 10 says we are "created in Christ Jesus for good works." How do these two statements work together? What goes wrong when you emphasize one without the other?
3. Paul describes the cross as demolishing "the dividing wall of hostility" between Jew and Gentile. What are the equivalent walls of hostility in your own community -- racial, economic, cultural, political -- and what does it mean that Christ has already broken them down?
