...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/Col.3" target="_blank" rel="noopener">Colossians chapter 3</a>
...
- **Identity-based ethics** — Christian behavior flows not from external rules but from the internal reality of union with Christ; we live out what we already are in him
- **Put off / put on** — Sanctification involves both the active discarding of old-self behaviors and the intentional cultivation of Christ-like character, a comprehensive wardrobe change of the soul
- **Transformed relationships** — The gospel reshapes every social relationship — marriage, parenting, work — by placing all human interactions under the lordship of Christ, where mutual love and service replace hierarchy and exploitation
