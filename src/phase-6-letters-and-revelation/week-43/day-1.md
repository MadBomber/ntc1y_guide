...
Listen to: <a href="https://www.biblegateway.com/audio/mclean/esv/1Tim.1" target="_blank" rel="noopener">1 Timothy chapter 1</a>
...
- **Sound doctrine as spiritual health** — Paul uses medical language ("sound teaching") to frame false doctrine as disease and the gospel as healing, establishing that what a church believes directly determines its spiritual vitality
- **Grace transforming the worst sinner** — Paul's personal testimony of being the "chief of sinners" saved by overflowing grace serves as both a model of honest confession and an assurance that no one is beyond Christ's reach
- **The proper use of the law** — The law is "good if one uses it properly" (1:8), functioning not to justify the righteous but to expose and restrain sin, pointing people toward the gospel rather than replacing it
